    ...
    <div id="frame">
        ...
        <nav class="navbar navbar-light bg-light">
            ...
            <span class="text-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
              ...
              </svg>  ALERT DEVICE</span>
        </nav>
        <div style=" margin-top: 20px; margin-left: 20px;" >
            <div class="row">

                <!-- HTML !-->
<button class="button-29" role="button" wire:click="alertDeviceStart"><svg style="margin-right:6px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
