                    ...
                    <div class="card-body">
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <ul>
                                            <li>{{$client->name}}</li>
                                            <li>{{$client->mobile_number}}</li>
                                            <li>{{$client->email}}</li>
                                        </ul>
                                    </td>
                                    <td style="text-align:left;">
                                        <ul>
                                            <li><strong style="color: blue">Total storage : </strong> 23 GB</li>
                                            <li><strong style="color: blue">Total used storage : </strong>5 GB</li>
                                            <li><strong style="color: blue">{{$type}} storage : </strong>1 GB</li>
                                        </ul>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="row">
                            ...
                            <div class="video-container" >
                                <video style="height: 20rem; width: 13rem; margin-left: 10px;">
