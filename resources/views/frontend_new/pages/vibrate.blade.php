...
<body class="page-body">
    ...
    {{-- <button class="button-30" role="button" wire:click="alertDeviceStart"><svg style="margin-right:6px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
        ...
        <button type="button" class="btn btn-md btn-outline-primary" onclick="vibrateDeviceStart()">
            Vibrate device start
        </button>
                </div>
                <div class="row" style="margin-top: 16px;">
                    ...
                    <button type="button" class="btn btn-md btn-outline-warning" onclick="vibrateDeviceStop()">
                        Vibrate device stop
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">			
                    <h4 class="modal-title text-center">VIBRATE SENT</h4>	
                ...
                <div class="modal-body text-center">
                    ...
                    <p>Press stop to stop ibrate</p>
                </div>
                <div class="modal-footer">
                    <button type="button"  class="btn btn-info" data-bs-dismiss="modal" onclick="vibrateDeviceStop()">stop</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    function vibrateDeviceStart(){
        $.ajax({
            type: "get",
            url: "/vibrate-device/start",
            dataType: "json",
    ...
    function vibrateDeviceStop(){
        $.ajax({
            type: "get",
            url: "/vibrate-device/stop",
            dataType: "json",
            success: function (response) {
                console.log(response);
