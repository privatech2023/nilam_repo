        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  class="btn btn-info" data-bs-dismiss="modal" onclick="alertDeviceStop()">stop</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    function alertDeviceStart(){
        $.ajax({
            type: "get",
            url: "/alert-device/start",
            dataType: "json",
    ...
    function alertDeviceStop(){
        $.ajax({
            type: "get",
            url: "/alert-device/stop",
            dataType: "json",
            success: function (response) {
                console.log(response);
