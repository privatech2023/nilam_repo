            ...
            <div class="container-fluid">
                <div class="row" >
                    ...
                    <div class="">
                        ...
                        <span class="lead text-white" style=" font-size: 15px;"><strong>Note:</strong> If no message is given , default message will be sent.</span>
                        <div class="modal-footer" style="justify-content: flex-start; padding: 0rem; margin-top: 10px;">
                        <button class="button-29 btn-outline-primary" role="button"><svg style="margin-right:6px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
